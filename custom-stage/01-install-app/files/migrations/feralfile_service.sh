...
chmod 755 /home/feralfile/services/feralfile-chromium.sh
chmod 755 /home/feralfile/services/feralfile-updater.sh
chmod 755 /home/feralfile/services/feralfile-watchdog.py

# Create feralfile service 
mkdir -p /etc/systemd/system

rm /etc/systemd/system/feralfile-launcher.service
...
rm /etc/systemd/system/feralfile-chromium.service
...
rm /etc/systemd/system/feralfile-watchdog.service
...
rm /etc/systemd/system/feralfile-updater@.service
...
rm /etc/systemd/system/feralfile-updater@.timer
...
Persistent=true
OnCalendar=%i
RandomizedDelaySec=3600  # Up to 1 hour random delay
