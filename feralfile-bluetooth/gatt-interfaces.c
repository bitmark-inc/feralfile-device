...
static const GDBusPropertyInfo * const _gatt_service1_property_info_pointers[] =
{
  &_gatt_service1_property_info_uuid.parent_struct,
  &_gatt_service1_property_info_primary.parent_struct,
  NULL
};
 ...
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_service1_dup_uuid() if on another thread.
 *
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = (const _ExtendedGDBusPropertyInfo *) _gatt_service1_property_info_pointers[prop_id - 1];
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL &&
        ...
        _gatt_service1_schedule_emit_changed (skeleton, info, prop_id, &skeleton->priv->properties[prop_id - 1]);
...
static const GDBusArgInfo * const _gatt_characteristic1_method_info_write_value_IN_ARG_pointers[] =
{
  &_gatt_characteristic1_method_info_write_value_IN_ARG_value.parent_struct,
  &_gatt_characteristic1_method_info_write_value_IN_ARG_options.parent_struct,
  NULL
};
...
static const GDBusMethodInfo * const _gatt_characteristic1_method_info_pointers[] =
{
  &_gatt_characteristic1_method_info_write_value.parent_struct,
  NULL
};
...
static const GDBusPropertyInfo * const _gatt_characteristic1_property_info_pointers[] =
{
  &_gatt_characteristic1_property_info_uuid.parent_struct,
  &_gatt_characteristic1_property_info_service.parent_struct,
  &_gatt_characteristic1_property_info_flags.parent_struct,
  NULL
};
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_characteristic1_dup_uuid() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_characteristic1_dup_service() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_characteristic1_dup_flags() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
...
void
gatt_characteristic1_complete_write_value (
    GattCharacteristic1 *object G_GNUC_UNUSED,
    GDBusMethodInvocation *invocation)
{
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = (const _ExtendedGDBusPropertyInfo *) _gatt_characteristic1_property_info_pointers[prop_id - 1];
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (object), info->parent_struct.name);
  if (info->use_gvariant)
    {
      g_value_set_variant (value, variant);
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL &&
          info->emits_changed_signal)
        _gatt_characteristic1_schedule_emit_changed (skeleton, info, prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
